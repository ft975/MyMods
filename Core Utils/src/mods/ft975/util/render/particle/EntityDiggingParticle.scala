...
import net.minecraft.client.renderer.{Tessellator => Tess}
...
class EntityDiggingParticle(
	...
	override def renderParticle(tess: Tess, deltaV: Float, xVal: Float, yVal: Float, zVal: Float, uMod: Float, vMod: Float) {
