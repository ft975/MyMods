...
import mods.ft975.light.{Colors, Shapes}
...
object RenderUtil {
	...
	def renderBulbRays(bulb: ModelRenderer, rays: ModelRenderer, size: Float, renderRays: Boolean, col: Colors, isItem: Boolean, colTex: ResourceLocation) {
		//Start Context
		glPushMatrix()
